...
class ConstructorArgumentAssignmentGenerator extends AbstractConstructorTestGenerator {
    ...
    @Autowired
    ConstructorArgumentAssignmentGenerator(JavaParserFacade solver, TestGeneratorResultReporter reporter, VisitReporter visitReporter, NomenclatureFactory nomenclatures, ValueFactory valueFactory) {
