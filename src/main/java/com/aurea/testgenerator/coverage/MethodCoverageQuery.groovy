...
class MethodCoverageQuery {
    ...
    private MethodCoverageQuery(Unit unit, TypeDeclaration type, MethodDeclaration methodDeclaration, int anonymousClassIndex) {
        this.unit = unit
        this.type = type
    ...
    static MethodCoverageQuery of(Unit unit, TypeDeclaration type, MethodDeclaration method) {
    ...
    static MethodCoverageQuery of(Unit unit, MethodDeclaration method) {
