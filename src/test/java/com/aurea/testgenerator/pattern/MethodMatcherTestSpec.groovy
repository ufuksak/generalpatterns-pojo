...
abstract class MethodMatcherTestSpec<T extends AbstractSubjectMethodMatcher> extends Specification {
    ...
    protected Optional<PatternMatch> runOnMethod(String methodCode) {
        ...
        matcher.matchMethod(unit, unit.cu.findAll(MethodDeclaration).first())
    }

    protected Optional<PatternMatch> runOnClass(String classCode) {
