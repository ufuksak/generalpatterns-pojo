...
import static com.aurea.testgenerator.generation.source.AssertionBuilder.FLOATING_POINT_OFFSET_DOUBLE
import static com.aurea.testgenerator.generation.source.AssertionBuilder.FLOATING_POINT_OFFSET_FLOAT
...
class AssertionBuilderSpec extends TestUnitSpec {
    ...
    def "correctly build for floating numbers"() {
        ...
        "0.1f"   | "0.2f"   | FLOATING_POINT_OFFSET_FLOAT  | PrimitiveType.floatType()
        "0.001f" | "2.3f"   | FLOATING_POINT_OFFSET_FLOAT  | parseType('Float')
        "0.001f" | "2.3f"   | FLOATING_POINT_OFFSET_FLOAT  | parseType('java.lang.Float')
        "0.001"  | "2.3"    | FLOATING_POINT_OFFSET_DOUBLE | PrimitiveType.doubleType()
        "0.001"  | "2.3"    | FLOATING_POINT_OFFSET_DOUBLE | parseType('Double')
        "0.001"  | "2.3"    | FLOATING_POINT_OFFSET_DOUBLE | parseType('java.lang.Double')
    }
    ...
    def "soft assertions are properly grouped"() {
        ...
        assertThat(statements.collect { it.node }
            ...
            sa.assertThat(3.4).isCloseTo(3.4, Offset.offset(${FLOATING_POINT_OFFSET_FLOAT}));
            sa.assertAll();
        """)
    }
