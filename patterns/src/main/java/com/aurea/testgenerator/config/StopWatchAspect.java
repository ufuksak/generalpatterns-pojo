...
public class StopWatchAspect {
    ...
    private static final Logger logger = LogManager.getLogger("Execution time");
    ...
    public Object profileExecuteMethod(ProceedingJoinPoint jointPoint) throws Throwable {
        ...
        SynchronizedStopWatch stopWatch = watches.computeIfAbsent(targetClass, s -> new SynchronizedStopWatch());
        stopWatch.start(methodName);

        Object result = jointPoint.proceed();

        stopWatch.stop();
        logger.info("{} executed {} times. Last call: {} ms. Total time: {} ms",
                methodName,
